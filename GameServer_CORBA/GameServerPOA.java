...
/**
* GameServer_CORBA/GameServerPOA.java .
...
public abstract class GameServerPOA extends org.omg.PortableServer.Servant
 implements GameServer_CORBA.GameServerOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // GameServer_CORBA/GameServer/createPlayerAccount
       {
       ...
       case 1:  // GameServer_CORBA/GameServer/playerSignIn
       {
         String Username = in.read_string ();
         String Password = in.read_string ();
         String IPAddress = in.read_string ();
       ...
       case 2:  // GameServer_CORBA/GameServer/playerSignOut
       {
         String Username = in.read_string ();
         String IPAddress = in.read_string ();
         String $result = null;
       ...
       case 3:  // GameServer_CORBA/GameServer/getPlayerStatus
       {
       ...
       case 4:  // GameServer_CORBA/GameServer/transferAccount
       {
         String Username = in.read_string ();
         String Password = in.read_string ();
       ...
       case 5:  // GameServer_CORBA/GameServer/suspendAccount
       {
         String AdminUsername = in.read_string ();
         String AdminPassword = in.read_string ();
  ...
  private static String[] __ids = {
    "IDL:GameServer_CORBA/GameServer:1.0"};
