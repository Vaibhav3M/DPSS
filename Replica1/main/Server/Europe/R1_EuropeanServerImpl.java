package Replica1.main.Server.Europe;

import GameServer_CORBA.GameServerPOA;
import Replica1.main.Constants.Constants;
import Replica1.main.Model.Player;
import Replica1.main.SendUDP.SendReceiveUDPMessage;
...
public class R1_EuropeanServerImpl extends GameServerPOA {
    ...
    protected R1_EuropeanServerImpl(Logger logger) {
        super();
        LOGGER = logger;
        addDummyData();
    }
    ...
    public String createPlayerAccount(String FirstName, String LastName, float Age, String Username, String Password, String IPAddress) {
        ...
        if (isLeader) {
            ...
            response1 = generateUDPResponse(Constants.L_SERVER_PORT_EUROPE, action);
            response2 = generateUDPResponse(Constants.R2_SERVER_PORT_EUROPE, action);
        }
    ...
    private boolean checkUserName(String userName) {
        ...
        String check_american = sendReceiveUDPMessage.getUDPResponse("3:" + userName, Constants.SERVER_PORT_AMERICA, Constants.SERVER_PORT_EUROPE);
        String check_asia = sendReceiveUDPMessage.getUDPResponse("3:" + userName, Constants.SERVER_PORT_ASIA, Constants.SERVER_PORT_EUROPE);
