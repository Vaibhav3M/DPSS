package Replica1.main.Server.Asia;
...
public class R1_AsianServerImpl extends GameServerPOA {
    ...
    protected R1_AsianServerImpl(Logger logger) {
        super();
        LOGGER = logger;
        addDummyData();
    }
    ...
    public String createPlayerAccount(String FirstName, String LastName, float Age, String Username, String Password, String IPAddress) {
        ...
        if (isLeader) {
            ...
            response1 = generateUDPResponse(Constants.L_SERVER_PORT_ASIA, action);
    ...
    private boolean checkUserName(String userName) {
        ...
        String check_american = sendReceiveUDPMessage.getUDPResponse("3:" + userName, Constants.SERVER_PORT_AMERICA, Constants.SERVER_PORT_ASIA);
        String check_europe = sendReceiveUDPMessage.getUDPResponse("3:" + userName, Constants.SERVER_PORT_EUROPE, Constants.SERVER_PORT_ASIA);
