...
import Replica1.Utilities.CustomLogger;
...
public class R1_EuropeanServer {
     ...
     */
    public static void recieve(R1_EuropeanServerImpl serverImpl) {
...
//                }
    ...
    public static void main(String args[]) {
        ...
        R1_EuropeanServerImpl serverImplementation = new R1_EuropeanServerImpl(LOGGER);
        ...
        try {
            ...
            System.out.println("R2_EuropeanServer launched at port : - " + Constants.SERVER_PORT_EUROPE);
