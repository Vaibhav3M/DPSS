package Replica_Faulty.Constants;
...
public class Constants {
    ...
    /* Game server names */
    public static final String SERVER_NAME_AMERICA = "F_AmericaGameServer";
    public static final String SERVER_NAME_EUROPE = "F_EuropeGameServer";
    public static final String SERVER_NAME_ASIA = "F_AsiaGameServer";

    /* Log storage locations */
    public static final String SERVER_LOG_DIRECTORY = "./Logs/Server_F/";
    public static final String PLAYER_LOG_DIRECTORY = "./Logs/Player_F/";
    public static final String ADMIN_LOG_DIRECTORY = "./Logs/Admin_F/";
