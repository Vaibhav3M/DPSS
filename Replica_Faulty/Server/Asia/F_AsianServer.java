package Replica_Faulty.Server.Asia;
...
public class F_AsianServer {
     ...
     */
    public static void recieve(F_AsianServerImpl serverImpl) {
...
//                }
    ...
    public static void main(String args[]) {
        ...
        F_AsianServerImpl serverImplementation = new F_AsianServerImpl(LOGGER);
        ...
        try {
            ...
            System.out.println("R2_AsianServer launched at port : - " + Constants.SERVER_PORT_ASIA);
